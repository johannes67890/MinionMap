...
public enum Type  {
    ...
    MOTORWAY("highway", new String[]{"motorway", "motorway_link"}, 9, 9, Color.web("#E892A2"), 5, true, 6, 100),
    PRIMARY_ROAD("highway", new String[]{"primary", "trunk"}, 9, 9, Color.web("#FCD6A4"), 5,  true, 6, 100),
