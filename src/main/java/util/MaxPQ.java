 ...
 * 
 * Sorts an array of a type, whereas the maximum value is placed at index 1.
...
public class MaxPQ<Key extends Comparable<Key>> {
    ...
    /**
     * Finds the maximum value and removes it from the queue.
     ...
     * @param i 
     * @param j
     * @return true if the value at index i is less than the value at index j, false if not.
     */
